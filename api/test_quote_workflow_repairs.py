...
class QuoteWorkflowRepairTestCase(TestCase):
    ...
    def _create_client_draft(self):
        return QuoteDraft.objects.create(
    ...
    def test_partner_can_send_quote_to_client_from_draft(self, mock_send):
        ...
        self.assertEqual(shop_quote.status, ShopQuoteStatus.SENT)
        self.assertEqual(shop_quote.sent_to_client_by_id, self.partner.id)
        self.assertEqual(shop_quote.client_quote_status, "sent")
