...
from quotes.models import CustomerInquiry, QuoteItem, QuoteItemAttachment, QuoteItemFinishing, QuoteRequest
...
class GalleryProductOptionsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "default_bleed_mm", "default_sides", "default_machine", "turnaround_days", "min_quantity",
