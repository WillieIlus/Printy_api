...
from quotes.models import QuoteDraftFile, QuoteItem, QuoteItemAttachment, QuoteItemFinishing, QuoteRequest, QuoteShareLink, ShopQuote
...
class QuoteDraftItemAttachmentViewSet(viewsets.ModelViewSet):
    """
    ...
    def get_quote_item(self):
        return get_object_or_404(
            ...
            quote_request_id=self.kwargs["quote_draft_pk"],
        )
...
class FinishingCategoryViewSet(viewsets.ReadOnlyModelViewSet):
    """
    GET /api/finishing-categories/ — list standard finishing categories.
    Read-only for all authenticated users; categories are seeded via migration.
    """
