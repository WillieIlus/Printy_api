...
from jobs.models import JobAssignment, JobFile, JobPayment, JobSettlementSplit, ManagedJob, ManagedJobEvent
...
def record_managed_job_event(
    *,
    ...
    payment: JobPayment | None = None,
    settlement: JobSettlementSplit | None = None,
    summary: str = "",
    metadata: dict[str, Any] | None = None,
) -> ManagedJobEvent:
    return ManagedJobEvent.objects.create(
