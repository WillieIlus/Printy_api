...
def managed_status_from_shop_quote_status(status: str | None) -> str:
    mapping = {
        ShopQuoteStatus.PENDING: ManagedJobStatus.DRAFT,
        ShopQuoteStatus.MODIFIED: ManagedJobStatus.QUOTED,
        ShopQuoteStatus.SENT: ManagedJobStatus.QUOTED,
        ShopQuoteStatus.REVISED: ManagedJobStatus.QUOTED,
        ShopQuoteStatus.ACCEPTED: ManagedJobStatus.AWAITING_PAYMENT,
        ShopQuoteStatus.REJECTED: ManagedJobStatus.CANCELLED,
        ShopQuoteStatus.DECLINED: ManagedJobStatus.CANCELLED,
        ShopQuoteStatus.EXPIRED: ManagedJobStatus.CANCELLED,
    }
    return mapping.get(status, ManagedJobStatus.DRAFT)
