        ...
        "latest_sent_quote": (
            {
                ...
                "turnaround_hours": latest_shop_quote.turnaround_hours,
                "estimated_ready_at": latest_shop_quote.estimated_ready_at.isoformat() if latest_shop_quote.estimated_ready_at else None,
                "human_ready_text": latest_shop_quote.human_ready_text,
                "turnaround_label": latest_shop_quote.turnaround_label,
...
def _build_quote_draft_file_payload(draft_file: QuoteDraftFile, *, statuses: list[str] | None = None) -> dict:
    ...
    drafts = (
        drafts
        .select_related("shop")
        .prefetch_related("items__product", "items__finishings__finishing_rate", "items__attachments", "shop_quotes")
