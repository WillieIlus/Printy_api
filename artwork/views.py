...
def _serialize_artwork(request, artwork: UploadedArtwork) -> dict:
    ...
    return {
        ...
        'detected_product_type': analysis.get('detected_product_type'),
        'page_count': analysis.get('page_count'),
        'page_sizes': analysis.get('page_sizes', []),
        'dominant_page_size': analysis.get('dominant_page_size'),
        'has_mixed_page_sizes': analysis.get('has_mixed_page_sizes', False),
        'booklet': analysis.get('booklet'),
